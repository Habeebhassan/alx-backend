...
describe('Test createPushNotificatinsJobs function', function() {
  ...
  it('show an error message if jobs is not an array', function() {
    ...
    const jobs = [
      {
        ...
        message: 'here is the code 1234 to verify your account'
      },
      {
        phoneNumber: '4153518781',
        message: 'here is the code 4562 to verify your account'
      },
    ];
