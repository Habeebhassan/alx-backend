#!/usr/bin/env python3
"""BasicCache module
Provides a simple caching mechanism using key-value pairs.
"""
...
class BasicCache(BaseCaching):
    """
    A basic caching system that stores key-value pairs in memory.
    ...
    def __init__(self):
        """
        Initialize the cache by calling the initializer of the parent class.
        """
        super().__init__()
